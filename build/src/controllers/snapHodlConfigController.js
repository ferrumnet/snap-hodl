...
exports.getAllSnapShots = exports.getSnapShotBySnapShotIdAndAddress = exports.createSnapHodlConfig = exports.getSnapHodlConfigs = exports.retrieveSnapHodlConfigs = void 0;
...
const getAllSnapShots = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const page = parseInt(req.query.page) || 1; // defaults to 1 if not provided
        const limit = parseInt(req.query.limit) || 10; // defaults to 10 if not provided
        const skip = (page - 1) * limit;
        // Find all documents in the collection with pagination
        const snapHodlConfigBalances = yield SnapHodlConfigBalance_1.default.find({}).skip(skip).limit(limit);
