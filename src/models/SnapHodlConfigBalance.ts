...
const stakingContractDataBalanceSchema =
  new Schema<IStakingContractDataBalance>({
...
const SnapHodlConfigBalanceModel = mongoose.model(
  "SnapHodlConfigBalanceModel",
  SnapHodlConfigBalanceSchema
);
